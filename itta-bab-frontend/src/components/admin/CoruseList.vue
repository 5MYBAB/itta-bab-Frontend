      ...
      <section class="content">
        <div class="content-header">
          ...
          <div class="search-bar">
            <input type="text" placeholder="원하는 제목으로 검색하세요." v-model="searchQuery" />
            <button class="register-btn" @click="goToInstitutionRegistration">등록</button> <!-- 등록 버튼 -->
          </div>
        </div>
        ...
        <table class="institution-table">
          ...
          <tbody>
          <tr v-for="(item, index) in paginatedInstitutions" :key="index">

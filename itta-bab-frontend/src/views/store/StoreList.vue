...
/* 테스트 데이터 */
const jsonData = [
  {"store_id": 1, "store_name": "아침"},
  {"store_id": 2, "store_name": "점심"},
  {"store_id": 3, "store_name": "저녁"},
  {"store_id": 4, "store_name": "오락"},
  {"store_id": 5, "store_name": "음주"}
];
...
const filter = (searchTerm) => {
  ...
  filteredData.value = jsonData.filter(item =>
      item.store_name.includes(searchTerm)
  );
  ...
  <div class="background">
    ...
    <div class="total-container">
      <div class="header-row">
        <div class="header-item">가게 ID</div>
      ...
      <div class="list-style">
        <div
            ...
            class="data-row"
        >
          <div class="data-item">{{ item.store_id }}</div>
          <div class="data-item">{{ item.store_name }}</div>
          <div class="data-item">
